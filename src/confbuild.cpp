...
std::string config_ss_libev = "{\"server\":\"?server?\",\"server_port\":?port?,\"password\":\"?password?\",\"method\":\"?method?\",\"plugin\":\"?plugin?\",\"plugin_opts\":\"?plugin_opts?\",\"plugin_args\":\"\",\"local_address\":\"127.0.0.1\",\"local_port\":?localport?,\"reuse_port\":true}";
...
std::string config_ssr_libev = "{\"server\":\"?server?\",\"server_port\":?port?,\"protocol\":\"?protocol?\",\"method\":\"?method?\",\"obfs\":\"?obfs?\",\"password\":\"?password?\",\"obfs_param\":\"?obfsparam?\",\"protocol_param\":\"?protoparam?\",\"local_address\":\"127.0.0.1\",\"local_port\":?localport?,\"reuse_port\":true}";
...
std::string base_trojan = "{\"run_type\":\"client\",\"local_addr\":\"127.0.0.1\",\"local_port\":?localport?,\"remote_addr\":\"?server?\",\"remote_port\":?port?,\"password\":[\"?password?\"],\"ssl\":{\"verify\":?verify?,\"verify_hostname\":?verify?,\"sni\":\"?host?\"},\"tcp\":{\"reuse_port\":true}}";
