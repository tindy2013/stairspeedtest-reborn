...
make -j4
rm stairspeedtest
g++ -o base/stairspeedtest CMakeFiles/stairspeedtest.dir/src/*.o  -static -lpcre2-8 -levent -lyaml-cpp -lPNGwriter -lpng -lfreetype -lcurl -lnghttp2 -lssl -lcrypto -lz -lbz2 -lbrotlicommon-static -lbrotlidec-static -ldl -lpthread -O3 -s  
